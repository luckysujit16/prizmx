        ...
        <div className={styles.p2pBox}>
          <div className={styles.p2prow}>
            ...
            <div className={styles.rowTopPadding}>           
              ...
              <div className={styles.rowTopPadding}>
              <div className={styles.p2pRowSixColumn}> Email <i class="bi bi-check"></i> Mobile <i class="bi bi-check"></i> Bank <i class="bi bi-check"></i></div>
               </div>
                ...
                <div className={styles.p2pRowFourColumn}>
                  ...
                  <span className={styles.fontSmall}>Success : 20 <br/>Failed : 2</span>
                  <span className={styles.fontSmallBold}>7 Days Trade Volume </span>
                  <span className={styles.fontSmall}>$ 512</span>
                  <span className={styles.fontSmallBold}>30 Days Trades</span>
                  <span className={styles.fontSmall}>$ 10250</span>
                  <span className={styles.fontSmallBold}>365 Days Trade Volume </span>
                  ...
                  <span ><i class="bi bi-hand-thumbs-up"></i>  20</span>
                  <span className={styles.fontSmallBold}>Negative Feedback</span>
                  <span>  <i class="bi bi-hand-thumbs-down"></i> 2</span>    
                </div>
                </div>
              </div>
