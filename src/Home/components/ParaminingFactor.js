  ...
  return (
    <div className={styles.para_section}>
      <div className="container-fluid">
        ...
        <div className="row px-5">
          <div className="col-lg-6 col-sm-12 col-xs-12 p-3 text-wrap">
          ...
          <div className="col-lg-6 col-sm-12 col-xs-12 p-3">
            ...
            <div className={styles.para_text}>
              ...
              <p>1. Personal balance</p>
              <p>2. Number of coins in the system</p>
              <p>3. Number of users in the system</p>
              <p className={styles.para_text_bold}>
