      ...
      <div className="container">
        <div className="row p-5">
          ...
          <div className="col-lg-6 col-sm-12 col-xs-12 my-5  p-5 text-start">
            ...
            <h1 className={styles.title}>How does PrizmX works?</h1>
            <div className="row">
              <p className={styles.featurebody}>
                PRIZM uses a system where each "coin" in a wallet's balance can
                be treated as miniature mining farm.
              </p>
              <p className={styles.featurebody}>
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      fake Market Maker Liquidity based order books on
                      centralized exchange or FAKE STABLE COIN based DeX
                      exchanges.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      deciding at what price they want to sell their asset like
                      any other tengible asset class i.e Property, Car, Daimond
                      etc.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      of PRIZMX for generating new coins then to VALUE of coin
                      is so low due to exccess supply on centralized exchanges
                      avilable through stable coins which is biggest threat to
                      decentralized nature of crypto currency. Hence we decided
                      to provide PARAMINING a main feature of PRIZM Coin in our
                      P2P Exchange wereby supply & price can remain 100%
                      Decentralized through REAL DEMAND & SUPPLY logic.
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
