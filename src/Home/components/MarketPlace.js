  ...
  return (
    <div className="container my-5">
      <div className="row">
          ...
          <div className="col-lg-12 col-sm-12 col-xs-12">
            <div className="row">
              ...
              <div className="col-11 fs-6 fw-bold text-start">
                <span className={styles.prospects}>FUTURE PROSPECTS</span>
              </div>
            </div>
          </div>
          <h1 className={styles.HowDoes}>PRIZMX Market Place</h1>
          <div className="row">
        ...
        <div className="col-lg-6 col-sm-12 col-xs-12 text-end">
          <img
            src={mkt_place_img}
