      ...
      <div className="container">
        <div className="row p-5">
          ...
          <div className="col-lg-6 col-sm-12 col-xs-12 my-5 text-start">
            ...
            <h1 className={styles.title}>Prizmx PARAMINING Calculator</h1>
            <div className="row">
              ...
              <p className={styles.featurebody}>
                Self wallet balance, network balance and paratax based
                difficulty level decides how much coins you mine. This
                calculator calculates accurate number of coins mined based on
                own balance, team balance and duration.
              </p>
            </div>
          </div>
        </div>
